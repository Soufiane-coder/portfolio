...
Explore my latest projects and articles, showcasing my expertise in web development and system protection.
              ...
              <div className="flex items-center self-start mt-2 lg:self-center">
                ...
                <Link href='mailto:amimisoufiane00@g@gmail.com' target="_blank" className="ml-4 text-lg font-medium capitalize text-dark underline dark:text-light md:text-base">Contact</Link>              
              </div>
            </div>
          </div>
        </Layout>
